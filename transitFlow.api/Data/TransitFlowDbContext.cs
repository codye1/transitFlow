    ...
    public class TransitFlowDbContext : IdentityDbContext<AppUser, IdentityRole<int>, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<IdentityRole<int>>().HasData(
                ...
                {
                    Id = (int)AppRole.User,
                    Name = AppRole.User.ToString().ToLowerInvariant(),
                    NormalizedName = AppRole.User.ToString().ToUpperInvariant(),
                    ConcurrencyStamp = "a6f8b9d2-3c4e-4f5a-8b1c-2d3e4f5a6b7c"
                },
                new IdentityRole<int>
                {
                    Id = (int)AppRole.Admin,
                    Name = AppRole.Admin.ToString().ToLowerInvariant(),
                    NormalizedName = AppRole.Admin.ToString().ToUpperInvariant(),
                    ConcurrencyStamp = "b7e9c0a1-4d5e-5f6a-9b2c-3d4e5f6a7b8c"
                },
                new IdentityRole<int>
                {
                    Id = (int)AppRole.Moderator,
                    Name = AppRole.Moderator.ToString().ToLowerInvariant(),
                    NormalizedName = AppRole.Moderator.ToString().ToUpperInvariant(),
