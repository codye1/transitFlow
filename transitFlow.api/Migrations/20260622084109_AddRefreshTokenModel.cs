        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stops_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "a6f8b9d2-3c4e-4f5a-8b1c-2d3e4f5a6b7c", "user", "USER" },
                    { 2, "b7e9c0a1-4d5e-5f6a-9b2c-3d4e5f6a7b8c", "admin", "ADMIN" },
                    { 3, "c8d0e1b2-5e6f-6a7b-0c3d-4e5f6a7b8c9d", "moderator", "MODERATOR" }
                });
